...
import com.famkit.db.famkit_db.dtos.UserDto;
import com.famkit.db.famkit_db.entity.Roles;
...
import com.famkit.db.famkit_db.service.RolesService;
...
//CRUD METHODS
	...
	public ResponseEntity<UserDto> insert(@RequestBody User obj) {
		...
		//external relation contacts
		if (obj.getContacts() != null) {
			if (obj.getContacts().get_id() == null)
				contactService.insert(obj.getContacts());
			else
				contactService.insert(contactService.getOne(obj.getContacts().get_id()));
		}
